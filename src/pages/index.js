  ...
  return (
    <Layout bodyClass="page-home">
      ...
      <Helmet>
        <meta
          name="description"
          content="Small Business Theme. Multiple content types using Markdown and JSON sources. Responsive design and SCSS. This is a beautiful and artfully designed starting theme." // FIXME: Update description
        />
      </Helmet>
